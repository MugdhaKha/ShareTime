<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Registration.ascx.cs" Inherits="ShareTime.controls.Registration" %>
<style>
    .w3-card-6
    {
...
<div class="page-container">
    <div class="row">
        ...
        <asp:DropDownList ID="Locality" runat="server" CssClass="form-control" placeholder="City">
            ...
            <br />
            <br />
        <asp:TextBox ID="Email" CssClass="form-control" runat="server" TextMode="SingleLine" placeholder="Email Address"></asp:TextBox>
            <br />
            <br />
        <asp:TextBox ID="PhNo" CssClass="form-control" runat="server" placeholder="Contact Number"></asp:TextBox>
            <br />
            <br />
        <asp:TextBox ID="Uname" CssClass="form-control"  runat="server" placeholder="User Name"></asp:TextBox>
            <br />
            <br />
       ...
       <asp:TextBox ID="RePassword" runat="server" CssClass="form-control" TextMode="Password" placeholder="Confirm Password"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
        <br /><asp:Button ID="Button1" runat="server" Text="Register" OnClick="Button1_Click" CssClass="form-control" />
            <br />
            <br />
            <br />
        </div>         
